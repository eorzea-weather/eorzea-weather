...
export const ZONE_EULMORE = 'eulmore';
...
export const ZONE_IL_MHEG = 'ilMheg';
export const ZONE_ISHGARD = 'ishgard';
export const ZONE_KHOLUSIA = 'kholusia';
export const ZONE_KUGANE = 'kugane';
export const ZONE_LAKELAND = 'lakeland';
...
export const ZONE_THE_CRYSTARIUM = 'theCrystarium';
export const ZONE_THE_DIADEM = 'theDiadem';
